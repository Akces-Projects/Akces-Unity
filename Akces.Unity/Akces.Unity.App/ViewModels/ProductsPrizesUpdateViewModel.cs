...
namespace Akces.Unity.App.ViewModels
{
    ...
    public class ProductsPricesUpdateViewModel : ControlViewModel
    {
        ...
        private async Task LoadProductsAsync() 
        {
            ...
            {
                var assortment = assortments.FirstOrDefault(x => x.Symbol == product.Symbol || x.Name == product.Name || x.Ean == product.EAN);
        ...
        private async Task ModifyPricesAsync() 
        {
            ...
            var updateProductPricesOperation = new UpdateProductsPricesOperation(SelectedAccount, true, productsToModify);
